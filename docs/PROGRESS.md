...
| 07 | [Flow Engine](./specs/07-flow-engine.md)                                                | In Progress | 07a, 07b, 07c, 07d  | Spec sliced into four plans. 07a shipped (schema + models). 07b–07d still ahead. |
...
| 07c | [Flow ingestion integration + auto-assign depth](./plans/07c-2026-05-15-flow-ingestion-integration.md) | 07 | In Progress | — | — |
